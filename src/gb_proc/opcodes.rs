...
op_codes!(
    ...
    //
    // nn = two byte immediate value. (LS byte first.)
    CallNZnn: ("CALL NZ,nn", 0xC4, 24, call_NZ_nn),
    CallZnn:  ("CALL Z,nn",  0xCC, 24, call_Z_nn),
    CallNCnn: ("CALL NC,nn", 0xD4, 24, call_NC_nn),
    CallCnn:  ("CALL C,nn",  0xDC, 24, call_C_nn),
    ...
    Rst00: ("RST 00H", 0xC7, 16, rst_00),
    Rst08: ("RST 08H", 0xCF, 16, rst_08),
    Rst10: ("RST 10H", 0xD7, 16, rst_10),
    Rst18: ("RST 18H", 0xDF, 16, rst_18),
    Rst20: ("RST 20H", 0xE7, 16, rst_20),
    Rst28: ("RST 28H", 0xEF, 16, rst_28),
    Rst30: ("RST 30H", 0xF7, 16, rst_30),
    Rst38: ("RST 38H", 0xFF, 16, rst_38),
    ...
    // H - Reset
    // C - Reset
    SwapA:  ("SWAP A",    0x37, 12, swap_A),
    SwapB:  ("SWAP B",    0x30, 12, swap_B),
    SwapC:  ("SWAP C",    0x31, 12, swap_C),
    SwapD:  ("SWAP D",    0x32, 12, swap_D),
    SwapE:  ("SWAP E",    0x33, 12, swap_E),
    SwapH:  ("SWAP H",    0x34, 12, swap_H),
    SwapL:  ("SWAP L",    0x35, 12, swap_L),
    SwapHL: ("SWAP (HL)", 0x36, 20, swap_HL),
    ...
    // H - Reset
    // C - Contains old bit 7 data.
    RlcA:  ("RLC A",    0x07, 12, rlc_A),
    RlcB:  ("RLC B",    0x00, 12, rlc_B),
    RlcC:  ("RLC C",    0x01, 12, rlc_C),
    RlcD:  ("RLC D",    0x02, 12, rlc_D),
    RlcE:  ("RLC E",    0x03, 12, rlc_E),
    RlcH:  ("RLC H",    0x04, 12, rlc_H),
    RlcL:  ("RLC L",    0x05, 12, rlc_L),
    RlcHL: ("RLC (HL)", 0x06, 20, rlc_HL),
    ...
    // H - Reset
    // C - Contains old bit 7 data
    RlA:  ("RL A",    0x17, 12, rl_A),
    RlB:  ("RL B",    0x10, 12, rl_B),
    RlC:  ("RL C",    0x11, 12, rl_C),
    RlD:  ("RL D",    0x12, 12, rl_D),
    RlE:  ("RL E",    0x13, 12, rl_E),
    RlH:  ("RL H",    0x14, 12, rl_H),
    RlL:  ("RL L",    0x15, 12, rl_L),
    RlHL: ("RL (HL)", 0x16, 20, rl_HL),
    ...
    // H - Reset
    // C - Contains old bit 0 data.
    RrcA:  ("RRC A",    0x0F, 12, rrc_A),
    RrcB:  ("RRC B",    0x08, 12, rrc_B),
    RrcC:  ("RRC C",    0x09, 12, rrc_C),
    RrcD:  ("RRC D",    0x0A, 12, rrc_D),
    RrcE:  ("RRC E",    0x0B, 12, rrc_E),
    RrcH:  ("RRC H",    0x0C, 12, rrc_H),
    RrcL:  ("RRC L",    0x0D, 12, rrc_L),
    RrcHL: ("RRC (HL)", 0x0E, 20, rrc_HL),
    ...
    // H - Reset
    // C - Contains old bit 0 data
    RrA:  ("RR A",    0x1F, 12, rr_A),
    RrB:  ("RR B",    0x18, 12, rr_B),
    RrC:  ("RR C",    0x19, 12, rr_C),
    RrD:  ("RR D",    0x1A, 12, rr_D),
    RrE:  ("RR E",    0x1B, 12, rr_E),
    RrH:  ("RR H",    0x1C, 12, rr_H),
    RrL:  ("RR L",    0x1D, 12, rr_L),
    RrHL: ("RR (HL)", 0x1E, 20, rr_HL),
    ...
    // H - Reset
    // C - Contains old bit 7 data
    SlaA:  ("SLA A",    0x27, 12, sla_A),
    SlaB:  ("SLA B",    0x20, 12, sla_B),
    SlaC:  ("SLA C",    0x21, 12, sla_C),
    SlaD:  ("SLA D",    0x22, 12, sla_D),
    SlaE:  ("SLA E",    0x23, 12, sla_E),
    SlaH:  ("SLA H",    0x24, 12, sla_H),
    SlaL:  ("SLA L",    0x25, 12, sla_L),
    SlaHL: ("SLA (HL)", 0x26, 20, sla_HL),
    ...
    // H - Reset
    // C - Contains old bit 0 data
    SraA:  ("SRA A",    0x2F, 12, sra_A),
    SraB:  ("SRA B",    0x28, 12, sra_B),
    SraC:  ("SRA C",    0x29, 12, sra_C),
    SraD:  ("SRA D",    0x2A, 12, sra_D),
    SraE:  ("SRA E",    0x2B, 12, sra_E),
    SraH:  ("SRA H",    0x2C, 12, sra_H),
    SraL:  ("SRA L",    0x2D, 12, sra_L),
    SraHL: ("SRA (HL)", 0x2E, 20, sra_HL),
    ...
    // H - Reset
    // C - Contains old bit 0 data
    SrlA:  ("SRL A",    0x3F, 12, srl_A),
    SrlB:  ("SRL B",    0x38, 12, srl_B),
    SrlC:  ("SRL C",    0x39, 12, srl_C),
    SrlD:  ("SRL D",    0x3A, 12, srl_D),
    SrlE:  ("SRL E",    0x3B, 12, srl_E),
    SrlH:  ("SRL H",    0x3C, 12, srl_H),
    SrlL:  ("SRL L",    0x3D, 12, srl_L),
    SrlHL: ("SRL (HL)", 0x3E, 20, srl_HL),
    ...
    // H - Set
    // C - Not affected
    Bit0A:  ("BIT 0,A",    0x47, 12, bit_0_A),
    Bit0B:  ("BIT 0,B",    0x40, 12, bit_0_B),
    Bit0C:  ("BIT 0,C",    0x41, 12, bit_0_C),
    Bit0D:  ("BIT 0,D",    0x42, 12, bit_0_D),
    Bit0E:  ("BIT 0,E",    0x43, 12, bit_0_E),
    Bit0H:  ("BIT 0,H",    0x44, 12, bit_0_H),
    Bit0L:  ("BIT 0,L",    0x45, 12, bit_0_L),
    Bit0HL: ("BIT 0,(HL)", 0x46, 20, bit_0_HL),

    Bit1A:  ("BIT 1,A",    0x4F, 12, bit_1_A),
    Bit1B:  ("BIT 1,B",    0x48, 12, bit_1_B),
    Bit1C:  ("BIT 1,C",    0x49, 12, bit_1_C),
    Bit1D:  ("BIT 1,D",    0x4A, 12, bit_1_D),
    Bit1E:  ("BIT 1,E",    0x4B, 12, bit_1_E),
    Bit1H:  ("BIT 1,H",    0x4C, 12, bit_1_H),
    Bit1L:  ("BIT 1,L",    0x4D, 12, bit_1_L),
    Bit1HL: ("BIT 1,(HL)", 0x4E, 20, bit_1_HL),

    Bit2A:  ("BIT 2,A",    0x57, 12, bit_2_A),
    Bit2B:  ("BIT 2,B",    0x50, 12, bit_2_B),
    Bit2C:  ("BIT 2,C",    0x51, 12, bit_2_C),
    Bit2D:  ("BIT 2,D",    0x52, 12, bit_2_D),
    Bit2E:  ("BIT 2,E",    0x53, 12, bit_2_E),
    Bit2H:  ("BIT 2,H",    0x54, 12, bit_2_H),
    Bit2L:  ("BIT 2,L",    0x55, 12, bit_2_L),
    Bit2HL: ("BIT 2,(HL)", 0x56, 20, bit_2_HL),

    Bit3A:  ("BIT 3,A",    0x5F, 12, bit_3_A),
    Bit3B:  ("BIT 3,B",    0x58, 12, bit_3_B),
    Bit3C:  ("BIT 3,C",    0x59, 12, bit_3_C),
    Bit3D:  ("BIT 3,D",    0x5A, 12, bit_3_D),
    Bit3E:  ("BIT 3,E",    0x5B, 12, bit_3_E),
    Bit3H:  ("BIT 3,H",    0x5C, 12, bit_3_H),
    Bit3L:  ("BIT 3,L",    0x5D, 12, bit_3_L),
    Bit3HL: ("BIT 3,(HL)", 0x5E, 20, bit_3_HL),

    Bit4A:  ("BIT 4,A",    0x67, 12, bit_4_A),
    Bit4B:  ("BIT 4,B",    0x60, 12, bit_4_B),
    Bit4C:  ("BIT 4,C",    0x61, 12, bit_4_C),
    Bit4D:  ("BIT 4,D",    0x62, 12, bit_4_D),
    Bit4E:  ("BIT 4,E",    0x63, 12, bit_4_E),
    Bit4H:  ("BIT 4,H",    0x64, 12, bit_4_H),
    Bit4L:  ("BIT 4,L",    0x65, 12, bit_4_L),
    Bit4HL: ("BIT 4,(HL)", 0x66, 20, bit_4_HL),

    Bit5A:  ("BIT 5,A",    0x6F, 12, bit_5_A),
    Bit5B:  ("BIT 5,B",    0x68, 12, bit_5_B),
    Bit5C:  ("BIT 5,C",    0x69, 12, bit_5_C),
    Bit5D:  ("BIT 5,D",    0x6A, 12, bit_5_D),
    Bit5E:  ("BIT 5,E",    0x6B, 12, bit_5_E),
    Bit5H:  ("BIT 5,H",    0x6C, 12, bit_5_H),
    Bit5L:  ("BIT 5,L",    0x6D, 12, bit_5_L),
    Bit5HL: ("BIT 5,(HL)", 0x6E, 20, bit_5_HL),

    Bit6A:  ("BIT 6,A",    0x77, 12, bit_6_A),
    Bit6B:  ("BIT 6,B",    0x70, 12, bit_6_B),
    Bit6C:  ("BIT 6,C",    0x71, 12, bit_6_C),
    Bit6D:  ("BIT 6,D",    0x72, 12, bit_6_D),
    Bit6E:  ("BIT 6,E",    0x73, 12, bit_6_E),
    Bit6H:  ("BIT 6,H",    0x74, 12, bit_6_H),
    Bit6L:  ("BIT 6,L",    0x75, 12, bit_6_L),
    Bit6HL: ("BIT 6,(HL)", 0x76, 20, bit_6_HL),

    Bit7A:  ("BIT 7,A",    0x7F, 12, bit_7_A),
    Bit7B:  ("BIT 7,B",    0x78, 12, bit_7_B),
    Bit7C:  ("BIT 7,C",    0x79, 12, bit_7_C),
    Bit7D:  ("BIT 7,D",    0x7A, 12, bit_7_D),
    Bit7E:  ("BIT 7,E",    0x7B, 12, bit_7_E),
    Bit7H:  ("BIT 7,H",    0x7C, 12, bit_7_H),
    Bit7L:  ("BIT 7,L",    0x7D, 12, bit_7_L),
    Bit7HL: ("BIT 7,(HL)", 0x7E, 20, bit_7_HL),
    ...
    // b = 0 - 7
    // r = A,B,C,D,E,H,L,(HL)
    Set0A:  ("SET 0,A",    0xC7, 12, set_0_A),
    Set0B:  ("SET 0,B",    0xC0, 12, set_0_B),
    Set0C:  ("SET 0,C",    0xC1, 12, set_0_C),
    Set0D:  ("SET 0,D",    0xC2, 12, set_0_D),
    Set0E:  ("SET 0,E",    0xC3, 12, set_0_E),
    Set0H:  ("SET 0,H",    0xC4, 12, set_0_H),
    Set0L:  ("SET 0,L",    0xC5, 12, set_0_L),
    Set0HL: ("SET 0,(HL)", 0xC6, 20, set_0_HL),

    Set1A:  ("SET 1,A",    0xCF, 12, set_1_A),
    Set1B:  ("SET 1,B",    0xC8, 12, set_1_B),
    Set1C:  ("SET 1,C",    0xC9, 12, set_1_C),
    Set1D:  ("SET 1,D",    0xCA, 12, set_1_D),
    Set1E:  ("SET 1,E",    0xCB, 12, set_1_E),
    Set1H:  ("SET 1,H",    0xCC, 12, set_1_H),
    Set1L:  ("SET 1,L",    0xCD, 12, set_1_L),
    Set1HL: ("SET 1,(HL)", 0xCE, 20, set_1_HL),

    Set2A:  ("SET 2,A",    0xD7, 12, set_2_A),
    Set2B:  ("SET 2,B",    0xD0, 12, set_2_B),
    Set2C:  ("SET 2,C",    0xD1, 12, set_2_C),
    Set2D:  ("SET 2,D",    0xD2, 12, set_2_D),
    Set2E:  ("SET 2,E",    0xD3, 12, set_2_E),
    Set2H:  ("SET 2,H",    0xD4, 12, set_2_H),
    Set2L:  ("SET 2,L",    0xD5, 12, set_2_L),
    Set2HL: ("SET 2,(HL)", 0xD6, 20, set_2_HL),

    Set3A:  ("SET 3,A",    0xDF, 12, set_3_A),
    Set3B:  ("SET 3,B",    0xD8, 12, set_3_B),
    Set3C:  ("SET 3,C",    0xD9, 12, set_3_C),
    Set3D:  ("SET 3,D",    0xDA, 12, set_3_D),
    Set3E:  ("SET 3,E",    0xDB, 12, set_3_E),
    Set3H:  ("SET 3,H",    0xDC, 12, set_3_H),
    Set3L:  ("SET 3,L",    0xDD, 12, set_3_L),
    Set3HL: ("SET 3,(HL)", 0xDE, 20, set_3_HL),

    Set4A:  ("SET 4,A",    0xE7, 12, set_4_A),
    Set4B:  ("SET 4,B",    0xE0, 12, set_4_B),
    Set4C:  ("SET 4,C",    0xE1, 12, set_4_C),
    Set4D:  ("SET 4,D",    0xE2, 12, set_4_D),
    Set4E:  ("SET 4,E",    0xE3, 12, set_4_E),
    Set4H:  ("SET 4,H",    0xE4, 12, set_4_H),
    Set4L:  ("SET 4,L",    0xE5, 12, set_4_L),
    Set4HL: ("SET 4,(HL)", 0xE6, 20, set_4_HL),

    Set5A:  ("SET 5,A",    0xEF, 12, set_5_A),
    Set5B:  ("SET 5,B",    0xE8, 12, set_5_B),
    Set5C:  ("SET 5,C",    0xE9, 12, set_5_C),
    Set5D:  ("SET 5,D",    0xEA, 12, set_5_D),
    Set5E:  ("SET 5,E",    0xEB, 12, set_5_E),
    Set5H:  ("SET 5,H",    0xEC, 12, set_5_H),
    Set5L:  ("SET 5,L",    0xED, 12, set_5_L),
    Set5HL: ("SET 5,(HL)", 0xEE, 20, set_5_HL),

    Set6A:  ("SET 6,A",    0xF7, 12, set_6_A),
    Set6B:  ("SET 6,B",    0xF0, 12, set_6_B),
    Set6C:  ("SET 6,C",    0xF1, 12, set_6_C),
    Set6D:  ("SET 6,D",    0xF2, 12, set_6_D),
    Set6E:  ("SET 6,E",    0xF3, 12, set_6_E),
    Set6H:  ("SET 6,H",    0xF4, 12, set_6_H),
    Set6L:  ("SET 6,L",    0xF5, 12, set_6_L),
    Set6HL: ("SET 6,(HL)", 0xF6, 20, set_6_HL),

    Set7A:  ("SET 7,A",    0xFF, 12, set_7_A),
    Set7B:  ("SET 7,B",    0xF8, 12, set_7_B),
    Set7C:  ("SET 7,C",    0xF9, 12, set_7_C),
    Set7D:  ("SET 7,D",    0xFA, 12, set_7_D),
    Set7E:  ("SET 7,E",    0xFB, 12, set_7_E),
    Set7H:  ("SET 7,H",    0xFC, 12, set_7_H),
    Set7L:  ("SET 7,L",    0xFD, 12, set_7_L),
    Set7HL: ("SET 7,(HL)", 0xFE, 20, set_7_HL),
    ...
    // b = 0 - 7
    // r = A,B,C,D,E,H,L,(HL)
    Reset0A:  ("RES 0,A",    0x87, 12, reset_0_A),
    Reset0B:  ("RES 0,B",    0x80, 12, reset_0_B),
    Reset0C:  ("RES 0,C",    0x81, 12, reset_0_C),
    Reset0D:  ("RES 0,D",    0x82, 12, reset_0_D),
    Reset0E:  ("RES 0,E",    0x83, 12, reset_0_E),
    Reset0H:  ("RES 0,H",    0x84, 12, reset_0_H),
    Reset0L:  ("RES 0,L",    0x85, 12, reset_0_L),
    Reset0HL: ("RES 0,(HL)", 0x86, 20, reset_0_HL),

    Reset1A:  ("RES 1,A",    0x8F, 12, reset_1_A),
    Reset1B:  ("RES 1,B",    0x88, 12, reset_1_B),
    Reset1C:  ("RES 1,C",    0x89, 12, reset_1_C),
    Reset1D:  ("RES 1,D",    0x8A, 12, reset_1_D),
    Reset1E:  ("RES 1,E",    0x8B, 12, reset_1_E),
    Reset1H:  ("RES 1,H",    0x8C, 12, reset_1_H),
    Reset1L:  ("RES 1,L",    0x8D, 12, reset_1_L),
    Reset1HL: ("RES 1,(HL)", 0x8E, 20, reset_1_HL),

    Reset2A:  ("RES 2,A",    0x97, 12, reset_2_A),
    Reset2B:  ("RES 2,B",    0x90, 12, reset_2_B),
    Reset2C:  ("RES 2,C",    0x91, 12, reset_2_C),
    Reset2D:  ("RES 2,D",    0x92, 12, reset_2_D),
    Reset2E:  ("RES 2,E",    0x93, 12, reset_2_E),
    Reset2H:  ("RES 2,H",    0x94, 12, reset_2_H),
    Reset2L:  ("RES 2,L",    0x95, 12, reset_2_L),
    Reset2HL: ("RES 2,(HL)", 0x96, 20, reset_2_HL),

    Reset3A:  ("RES 3,A",    0x9F, 12, reset_3_A),
    Reset3B:  ("RES 3,B",    0x98, 12, reset_3_B),
    Reset3C:  ("RES 3,C",    0x99, 12, reset_3_C),
    Reset3D:  ("RES 3,D",    0x9A, 12, reset_3_D),
    Reset3E:  ("RES 3,E",    0x9B, 12, reset_3_E),
    Reset3H:  ("RES 3,H",    0x9C, 12, reset_3_H),
    Reset3L:  ("RES 3,L",    0x9D, 12, reset_3_L),
    Reset3HL: ("RES 3,(HL)", 0x9E, 20, reset_3_HL),

    Reset4A:  ("RES 4,A",    0xA7, 12, reset_4_A),
    Reset4B:  ("RES 4,B",    0xA0, 12, reset_4_B),
    Reset4C:  ("RES 4,C",    0xA1, 12, reset_4_C),
    Reset4D:  ("RES 4,D",    0xA2, 12, reset_4_D),
    Reset4E:  ("RES 4,E",    0xA3, 12, reset_4_E),
    Reset4H:  ("RES 4,H",    0xA4, 12, reset_4_H),
    Reset4L:  ("RES 4,L",    0xA5, 12, reset_4_L),
    Reset4HL: ("RES 4,(HL)", 0xA6, 20, reset_4_HL),

    Reset5A:  ("RES 5,A",    0xAF, 12, reset_5_A),
    Reset5B:  ("RES 5,B",    0xA8, 12, reset_5_B),
    Reset5C:  ("RES 5,C",    0xA9, 12, reset_5_C),
    Reset5D:  ("RES 5,D",    0xAA, 12, reset_5_D),
    Reset5E:  ("RES 5,E",    0xAB, 12, reset_5_E),
    Reset5H:  ("RES 5,H",    0xAC, 12, reset_5_H),
    Reset5L:  ("RES 5,L",    0xAD, 12, reset_5_L),
    Reset5HL: ("RES 5,(HL)", 0xAE, 20, reset_5_HL),

    Reset6A:  ("RES 6,A",    0xB7, 12, reset_6_A),
    Reset6B:  ("RES 6,B",    0xB0, 12, reset_6_B),
    Reset6C:  ("RES 6,C",    0xB1, 12, reset_6_C),
    Reset6D:  ("RES 6,D",    0xB2, 12, reset_6_D),
    Reset6E:  ("RES 6,E",    0xB3, 12, reset_6_E),
    Reset6H:  ("RES 6,H",    0xB4, 12, reset_6_H),
    Reset6L:  ("RES 6,L",    0xB5, 12, reset_6_L),
    Reset6HL: ("RES 6,(HL)", 0xB6, 20, reset_6_HL),

    Reset7A:  ("RES 7,A",    0xBF, 12, reset_7_A),
    Reset7B:  ("RES 7,B",    0xB8, 12, reset_7_B),
    Reset7C:  ("RES 7,C",    0xB9, 12, reset_7_C),
    Reset7D:  ("RES 7,D",    0xBA, 12, reset_7_D),
    Reset7E:  ("RES 7,E",    0xBB, 12, reset_7_E),
    Reset7H:  ("RES 7,H",    0xBC, 12, reset_7_H),
    Reset7L:  ("RES 7,L",    0xBD, 12, reset_7_L),
    Reset7HL: ("RES 7,(HL)", 0xBE, 20, reset_7_HL)
);
